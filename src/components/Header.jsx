const Header = ({ notesList }) => {
  ...
  return (
    <div 
    className="bg-neutral-50/90 w-full h-20 flex justify-between items-center-safe rounded-b-2xl p-2 
    sm:px-3 sm:pt-2" 
    >
      ...
      <h1 className="text-blue-900 text-2xl font-serif sm:text-4xl">
      {
